...
public final class Factura implements Comprobante {
    ...
    public Factura(String serie, String correlativo, LocalDate fechaEmision, String rucEmisor, String documentoAdquiriente) {
        this.serie = serie;
